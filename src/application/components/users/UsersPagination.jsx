                                        ...
                                        usuario?.sucursal ?
                                            {
                                                ...
                                                rfc: usuario?.rfc,
                                                rol: usuario?.rol?.id,
                                                sucursal: usuario?.sucursal?.id,
                                                email: usuario?.email,
                                                direccion: usuario?.direccion,
                                                numTelefono: usuario?.numTelefono,
                                                activo: usuario?.activo,
                                                modulos: usuario?.modulos.map(module => {
                                                    return { nombre: module?.nombre, componente: module?.componente, ruta: module?.ruta, permisos: module?.permisos }
                                                })
                                            }
                                            : {
                                                id: usuario?.id,
